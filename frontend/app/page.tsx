    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
            ...
            >
              ...
              <AnimatePresence>
                {showAITooltip && (
                  ...
                  >
                    <div className="glass-strong p-4 rounded-xl shadow-2xl">
                      <div className="flex items-center gap-2 mb-2">
                        <Sparkles size={14} className="text-trippy-600" />
                        <span className="text-sm font-semibold">Create AI-Suggested Trip</span>
                      </div>
                      <p className="text-xs text-muted leading-relaxed">
                        Tell our AI where you want to go and it&apos;ll craft a complete
                        itinerary with flights, stays, activities & budget — in seconds.
                      </p>
                    </div>
                  </motion.div>
                )}
      ...
      <section className="relative mx-auto flex max-w-7xl flex-col items-center px-4 pt-20 pb-8 text-center lg:pt-32">
        ...
        >
          ...
          <span className="bg-trippy-gradient bg-clip-text text-transparent">
            together
          </span>
        </motion.h1>
        ...
        >
          <div className="glass-strong p-2 flex flex-col sm:flex-row items-stretch gap-2">
        ...
        >
          {STATS.map(({ value, label, icon: Icon }) => (
            <div key={label} className="glass-sm p-4 text-center group hover:bg-surface-hover transition-all cursor-default">
              ...
              <div className="text-2xl font-bold bg-trippy-gradient bg-clip-text text-transparent">
                {value}
              </div>
      ...
      {/* ════════════════════════════════════════════════════════════════
          DISCOVER & JOIN TRIPS
          ════════════════════════════════════════════════════════════ */}
      <section id="discover" className="mx-auto max-w-7xl px-4 py-20 lg:px-8">
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between mb-10">
          <div>
            <motion.div
              initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}
              className="inline-flex items-center gap-2 rounded-full bg-accent-400/10 px-4 py-1.5 text-xs font-semibold text-accent-600 mb-3"
            >
      ...
      <section id="ai-trips" className="relative overflow-hidden py-24">
        ...
        <div className="relative mx-auto max-w-7xl px-4 lg:px-8">
          <div className="text-center mb-16">
            ...
            >
              Let AI plan your{" "}
              <span className="bg-gradient-to-r from-trippy-300 via-trippy-400 to-accent-300 bg-clip-text text-transparent">
                dream trip
              </span>
            </motion.h2>
              ...
              <GlassCard variant="strong" className="p-0 overflow-hidden">
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="flex gap-3">
                    <div className="shrink-0 w-8 h-8 rounded-full bg-gradient-to-r from-trippy-500 to-trippy-400 flex items-center justify-center">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
              Trips that match{" "}
              <span className="bg-trippy-gradient bg-clip-text text-transparent">your style</span>
            </h2>
      ...
      <section id="how-it-works" className="relative py-24 overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-4 lg:px-8 text-center">
          ...
          >
            How Trippy{" "}
            <span className="bg-trippy-gradient bg-clip-text text-transparent">works</span>
          </motion.h2>
      ...
      <section id="features" className="mx-auto max-w-7xl px-4 py-20 lg:px-8">
        <div className="mb-14 text-center">
          <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
            ...
            <span className="bg-trippy-gradient bg-clip-text text-transparent">epic trips</span>
          </h2>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 lg:px-8">
        <div className="text-center mb-14">
          <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
            Loved by{" "}
            <span className="bg-trippy-gradient bg-clip-text text-transparent">travelers</span>
          </h2>
